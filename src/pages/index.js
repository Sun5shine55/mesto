...
const popupPlace = new PopupWithForm('.popup_new-place', newPlaceForm, createCardFormSubmit);//экземпляр класса PopupWithForm
...
const userInformation = new UserInfo({ name: '.profile__name', job: '.profile__myself', })

const popupProfile = new PopupWithForm('.popup_edit-profile', profileForm, handleProfileFormSubmit);//экземпляр класса PopupWithForm
